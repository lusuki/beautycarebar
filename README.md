...
5. Built bcb.war of bcb-interfaces is located in {workdir}/beautycarebar/bcb-interfaces/build/libs.
...
5. Copy bcb.war under {workdir}/beautycarebar/bcb-interfaces/build/libs to tomcat webapps folder.
...
7. Start tomcat on 8080, and try to visit http://localhost:8080/bcb/hello.
...
5. Rest apis root uri: http://localhost:8080/bcb/api
   Web pages root uri: http://localhost:8080/bcb 
